        ...
        {(provider, snapshot) => (
          <React.Fragment>
            ...
            >
              ...
              <td className="text-warning">{this.props.user.dateOfBirth}</td>
                ...
                <Dropdown>
                  ...
                  <Dropdown.Menu drop="left">
                    ...
                    <Dropdown.Item href="#/action-2">
                      <Icon path={mdiCheckCircleOutline} size={1} /> &nbsp;Phân quyền
                    </Dropdown.Item>
                    <Dropdown.Item href="#/action-2">
                      <Icon path={mdiAccountArrowRight} size={1} /> &nbsp; <span className="text-danger"> Rời nhóm</span> 
                    </Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
              </td>
